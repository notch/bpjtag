...
// new moded by hugebird at chinaadsl forum
...
#define DMA_HALFWORD    0x00000080	//DMA transfer size HALFWORD(double Bytes)
#define DMA_WORD        0x00000100	//DMA transfer size WORD (four Bytes)
#define DMA_TRIPLEBYTE  0x00000180	//DMA transfer size TRIPLEBYTE
  
#define END_MIPSLE			0	// Little Endian
#define END_MIPS	      1	// Big Endian
